...
public class LoggingAspect {
    ...
    @Pointcut("execution(* com.example.registration.controller..*(..))")
    public void controllerMethods() {}

    @Pointcut("execution(* com.example.registration.service..*(..))")
    public void serviceMethods() {}

    @Pointcut("execution(* com.example.registration.repository..*(..))")
