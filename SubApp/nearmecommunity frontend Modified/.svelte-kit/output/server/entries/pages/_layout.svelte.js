import { c as create_ssr_component, b as subscribe, d as add_attribute, v as validate_component, e as each, f as escape, o as onDestroy, g as add_styles, m as missing_component, h as spread, i as escape_object, j as merge_ssr_styles } from "../../chunks/ssr.js";
...
function createThemeStore() {
  const { subscribe: subscribe2, set, update: update2 } = writable("light");
  return {
...
const Navbar = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `<nav${add_attribute(
    "class",
    `fixed top-0 left-0 right-0 z-50 transition-all duration-200 ${"bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm"}`,
    0
  )}><div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8"><div class="flex justify-between h-16"><div class="flex"><div class="flex-shrink-0 flex items-center"><a href="/dashboard" class="flex items-center">${validate_component(Logo, "Logo").$$render($$result, {}, {}, {})} <span class="ml-2 text-xl font-bold text-gray-900 dark:text-white" data-svelte-h="svelte-19lo7sy">NearMe</span></a></div> <div class="hidden sm:ml-6 sm:flex sm:space-x-4">${each(navItems, (item) => {
    return `<a${add_attribute("href", item.path, 0)}${add_attribute(
      "class",
      `inline-flex items-center px-1 pt-1 border-b-2 text-sm font-medium ${isActive(item.path) ? "border-primary-500 text-gray-900 dark:text-white" : "border-transparent text-gray-500 dark:text-gray-300 hover:text-gray-700 dark:hover:text-white hover:border-gray-300"}`,
      0
    )}>${escape(item.name)} </a>`;
  })}</div></div> <div class="hidden sm:ml-6 sm:flex sm:items-center space-x-4"><button type="button" class="p-2 rounded-lg text-gray-500 hover:text-gray-700 dark:text-gray-400 dark:hover:text-gray-200 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-primary-500"><span class="sr-only" data-svelte-h="svelte-ntgole">Toggle theme</span> ${$theme === "dark" ? `<svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 3v1m0 16v1m9-9h-1M4 12H3m15.364 6.364l-.707-.707M6.343 6.343l-.707-.707m12.728 0l-.707.707M6.343 17.657l-.707.707M16 12a4 4 0 11-8 0 4 4 0 018 0z"></path></svg>` : `<svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M20.354 15.354A9 9 0 018.646 3.646 9.003 9.003 0 0012 21a9.003 9.003 0 008.354-5.646z"></path></svg>`}</button> <button type="button" class="p-1 rounded-full text-gray-400 hover:text-gray-500 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-primary-500" data-svelte-h="svelte-vadsnw"><span class="sr-only">View notifications</span> <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 17h5l-1.405-1.405A2.032 2.032 0 0118 14.158V11a6.002 6.002 0 00-4-5.659V5a2 2 0 10-4 0v.341C7.67 6.165 6 8.388 6 11v3.159c0 .538-.214 1.055-.595 1.436L4 17h5m6 0v1a3 3 0 11-6 0v-1m6 0H9"></path></svg></button> <div class="ml-3 relative"><div><button type="button" class="flex text-sm rounded-full focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-primary-500"><span class="sr-only" data-svelte-h="svelte-1tvisl5">Open user menu</span> <div class="h-8 w-8 rounded-full bg-primary-500 flex items-center justify-center text-white">${escape($user.userId ? $user.userId.charAt(0).toUpperCase() : "U")}</div></button></div> ${``}</div></div> <div class="flex items-center sm:hidden"><button type="button" class="inline-flex items-center justify-center p-2 rounded-md text-gray-400 hover:text-gray-500 hover:bg-gray-100 dark:hover:bg-gray-700 focus:outline-none focus:ring-2 focus:ring-inset focus:ring-primary-500"><span class="sr-only" data-svelte-h="svelte-1bvqpab">Open main menu</span> ${`<svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 6h16M4 12h16M4 18h16"></path></svg>`}</button></div></div></div> ${``}</nav>`;
});
const Footer = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  const currentYear = (/* @__PURE__ */ new Date()).getFullYear();
  return `<footer class="bg-white dark:bg-gray-800 shadow-inner fixed bottom-0 left-0 right-0 z-10"><div class="max-w-7xl mx-auto py-4 px-4 sm:px-6 lg:px-8"><div class="flex items-center justify-between"><div class="text-gray-500 dark:text-gray-400 text-sm">© ${escape(currentYear)} NearMe Community Platform</div> <div class="flex space-x-6" data-svelte-h="svelte-h5v2vo"><a href="/about" class="text-gray-500 dark:text-gray-400 hover:text-gray-700 dark:hover:text-gray-200 text-sm">About</a> <a href="/privacy" class="text-gray-500 dark:text-gray-400 hover:text-gray-700 dark:hover:text-gray-200 text-sm">Privacy</a> <a href="/terms" class="text-gray-500 dark:text-gray-400 hover:text-gray-700 dark:hover:text-gray-200 text-sm">Terms</a> <a href="/contact" class="text-gray-500 dark:text-gray-400 hover:text-gray-700 dark:hover:text-gray-200 text-sm">Contact</a></div></div></div></footer>`;
});
...
const Layout = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `${$navigating ? `<div class="fixed inset-0 flex items-center justify-center bg-white bg-opacity-75 z-50">${validate_component(LoadingSpinner, "LoadingSpinner").$$render($$result, { size: "lg" }, {}, {})}</div>` : ``} ${showNav ? `${validate_component(Navbar, "Navbar").$$render($$result, {}, {}, {})}` : ``} <main class="min-h-screen pb-16">${slots.default ? slots.default({}) : ``}</main> ${showNav ? `${validate_component(Footer, "Footer").$$render($$result, {}, {}, {})}` : ``} ${validate_component(Toaster, "Toaster").$$render($$result, { position: "top-right" }, {}, {})}`;
});
export {
  Layout as default
};
